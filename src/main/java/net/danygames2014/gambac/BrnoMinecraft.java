...
public class BrnoMinecraft extends Minecraft {
    ...
    @Override
    public void displayUnexpectedThrowable(UnexpectedThrowable throwable) { // displayUnexpectedThrowable(UnexpectedThrowable)
        this.frame.removeAll();
        this.frame.add(new PanelCrashReport(throwable), "Center");
        this.frame.validate();
    ...
    private void resize(int width, int height) {
        ...
        if (this.currentScreen != null) {
            ScaledResolution scaler = new ScaledResolution(this.gameSettings, width, height);
